...
export class MeterService {
  public selectedMeterData: MeterDataModel = {
    unit: '',
    unitvalue: '',
    datetime: '',
  };
  ...
  public updateValue(meter: MeterInfoModel) {
    return this.http.put(environment.baseUrl + `edit/${meter._id}`, meter, {
      responseType: 'text',
    });
  }
  ...
  public postMeterData(meterid: string) {
    return this.http.put(
      environment.baseUrl + `data/add/${meterid}`,
  ...
  public removeMeterData(meterdataid: string): Observable<any> {
    return this.http.put<any>(
      environment.baseUrl + `data/delete/${meterdataid}`,
      { responseType: 'text' }
    );
  }
  public editMeterData(dataid: string) {
    return this.http.put(
      environment.baseUrl + `data/edit/${dataid}`,
      this.selectedMeterData
    );
  }

  public uploadFile(fileData: FormData) {
  ...
  public uploadFileAndData(fileAndData: FormData) {
    // console.log(fileAndData);
    return this.http.post<any>(
      environment.baseUrl + 'uploadFileAndData',
      fileAndData,
      { responseType: 'json' }
    );
  }

  public uploadDisplayName(fileAndData: FormData) {
    return this.http.post<any>(
      environment.baseUrl + 'upload-display-name',
      fileAndData,
      { responseType: 'json' }
    );
  }

  public uploadCusum(fileAndData: FormData) {
    return this.http.post<any>(
      environment.baseUrl + 'upload-cusum',
      fileAndData,
      { responseType: 'json' }
    );
  }
